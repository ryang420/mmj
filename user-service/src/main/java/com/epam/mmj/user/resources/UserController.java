...
import com.epam.mmj.user.common.DuplicateUserException;
import com.epam.mmj.user.common.InvalidUserException;
import com.epam.mmj.user.common.UserNotFoundException;
import com.epam.mmj.user.domain.model.entity.Entity;
import com.epam.mmj.user.domain.model.entity.User;
import com.epam.mmj.user.domain.service.UserService;
import com.epam.mmj.user.domain.valueobject.UserVO;
...
public class UserController {
  ...
  public ResponseEntity<Entity> findById(@PathVariable("id") String id) throws Exception {
    logger.info(String
        .format("user-service findById() invoked:%s for %s ", userService.getClass().getName(),
            id));
    id = id.trim();
    Entity user;
    try {
